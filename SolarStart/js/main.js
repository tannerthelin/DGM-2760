...
// A function to add up all the month inputs and  divide by 365, and return the daily Kw usage.
...
function calculateSolar() {
	...
	var feedback = "";
	feedback += "<p>Based on your average daily use of " + Math.round(dailyUseKw) + " kWh, you will need to purchase " + panelsNeeded + " " + panelName + " solar panels to offset your electrical bill.</p>";
